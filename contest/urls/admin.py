...
from ..views.admin import ContestAnnouncementAPI, ContestAPI, ACMContestHelper, DownloadContestSubmissions, AddRLScore
...
urlpatterns = [
    ...
    url(r"^addRLScore/?$", AddRLScore.as_view(), name="addRL_score")
]
